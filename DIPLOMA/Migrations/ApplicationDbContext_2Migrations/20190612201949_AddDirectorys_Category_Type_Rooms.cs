...
{
    public partial class AddDirectorys_Category_Type_Rooms : Migration
    {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DirectoryRoomsID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    DirectoryCategoryID = table.Column<int>(nullable: false),
                    DirectoryTypeID = table.Column<int>(nullable: false),
                    NumberRoom = table.Column<string>(maxLength: 10, nullable: false),
                    DirectoryTypeRoomsID = table.Column<int>(nullable: true),
                    DirectoryCategoryRoomsID = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
